        ...
        <Container className="relative z-10">
          <StaggerContainer className="flex flex-col gap-8 max-w-5xl">
            ...
            <FadeInView delay={0.2}>
              <p className="text-xl md:text-3xl text-slate-400 leading-relaxed font-medium max-w-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <StaggerContainer className="flex flex-col gap-10">
              ...
              <FadeInView direction="left" delay={0.1}>
                <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-white leading-tight uppercase italic">
                  Hướng tới <br /> vận hành
                </h2>
              </FadeInView>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                { icon: Award, title: "Uy tín", desc: "Năng lực thật, con số thật, kết quả đo lường được.", offset: true },
                { icon: Users, title: "Đồng hành", desc: "Hỗ trợ sau triển khai, phát triển cùng khách hàng." },
                { icon: ShieldCheck, title: "Bền vững", desc: "Hệ thống ổn định, bảo mật và mở rộng cao.", offset: true }
              ].map((item, i) => (
                <ScaleInView key={i} delay={i * 0.1} className={`p-10 rounded-[40px] bg-slate-900 border border-slate-800 shadow-2xl transition-all duration-500 hover:border-cyan-500/40 group overflow-hidden relative ${item.offset ? 'md:mt-12' : ''}`}>
                  ...
                  <div className="w-20 h-20 rounded-[24px] bg-cyan-500/10 flex items-center justify-center mb-8 group-hover:bg-cyan-500/20 transition-all group-hover:scale-110 duration-500 relative z-10">
                    <item.icon className="w-10 h-10 text-cyan-400" />
                  </div>
                  <h3 className="text-2xl font-black text-white mb-4 uppercase tracking-tight relative z-10">{item.title}</h3>
                  <p className="text-base text-slate-400 leading-relaxed font-medium relative z-10">{item.desc}</p>
                </ScaleInView>
              ))}
            </StaggerContainer>
          </div>
        ...
        <Container>
          <div className="flex flex-col gap-20">
            <FadeInView className="max-w-5xl flex flex-col gap-10">
              <h2 className="text-4xl md:text-8xl font-black tracking-tighter text-white leading-tight uppercase">
                Đội ngũ là <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500">Nền tảng</span>
              </h2>
              <p className="text-2xl text-slate-400 leading-relaxed font-medium">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-20">
                <div className="flex-1">
                  <BlurInView delay={0.4}>
                    <p className="text-3xl md:text-5xl font-black text-white leading-tight italic opacity-90 tracking-tighter">
                ...
                <StaggerContainer className="flex items-center gap-16 shrink-0">
                  <FadeInView direction="up" delay={0.6} className="text-center">
                    <span className="block text-8xl font-black text-cyan-500 mb-2 tracking-tighter">56</span>
                  ...
                  <FadeInView direction="up" delay={0.8} className="text-center">
                    <span className="block text-8xl font-black text-cyan-500 mb-2 tracking-tighter">86%</span>
        ...
        <Container>
          <FadeInView className="bg-linear-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-[60px] p-16 md:p-32 relative overflow-hidden flex flex-col gap-20 shadow-3xl">
            ...
            <div className="max-w-4xl flex flex-col gap-8 relative z-10">
              <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-white leading-tight uppercase">
                Minh bạch <br /> năng lực
              </h2>
